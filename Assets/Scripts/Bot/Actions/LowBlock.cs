...
[Serializable]
public class LowBlock : IBotAction
{
    ...
    public void Action()
    {
        BotController.state = BotController.State.LowBlock;
        BotController.animator.SetTrigger("Low_Block");
    }

    public bool Condition()
    {
        if (PlayerController.state == PlayerController.State.LowAttack)
        {
