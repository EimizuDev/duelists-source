...
[Serializable]
public class LowAttack : IBotAction
{
    ...
    public void Action()
    {
        BotController.state = BotController.State.LowAttack;
        BotController.animator.SetTrigger("Low_Attack");
    }
    ...
    public bool Condition()
    {
        ...
        if (PlayerController.state == PlayerController.State.Parried || PlayerController.state == PlayerController.State.Idle || PlayerController.state == PlayerController.State.OverheadBlock || PlayerController.state == PlayerController.State.MiddleBlock || PlayerController.state == PlayerController.State.LowBlock)
        {
            return true;
        }
